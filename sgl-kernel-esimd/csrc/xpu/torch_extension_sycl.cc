...
TORCH_LIBRARY_FRAGMENT(sgl_kernel_esimd, m) {
  ...
  m.def("esimd_kernel_uni_huge_params(Tensor t0, Tensor t1, Tensor t2, Tensor t3, Tensor t4, Tensor t5, Tensor t6, Tensor t7, Tensor t8, Tensor t9, \
                          Tensor t10, Tensor t11, Tensor t12, Tensor t13, Tensor t14, Tensor t15, Tensor t16, Tensor t17, Tensor t18, Tensor t19,\
                          Tensor t20, Tensor t21, Tensor t22, Tensor t23, Tensor t24, Tensor t25, \
                          int i0, int i1, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, \ 
                          float f0, float f1, float f2, float f3, float f4) -> Tensor");
  m.impl("esimd_kernel_uni_huge_params", torch::kXPU, &esimd_kernel_uni_huge_params);
  //   m.def(
